let vega_lite_definition_1 = "js/nyc_rideshare-1.vg.json"
let vega_lite_definition_2 = "js/nyc_rideshare-2.vg.json"
let vega_lite_definition_3 = "js/nyc_rideshare-3.vg.json"
...
vegaEmbed('#visualisation-3', vega_lite_definition_3).then(result => { }).catch(console.error);
